...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var whiteboard:FlxSprite = new FlxSprite(0, -15).loadGraphic(Paths.image('da schoolhouse/menu/board', 'shared'));
		whiteboard.screenCenter();
		whiteboard.setGraphicSize(Std.int(whiteboard.width * 1.1));
		whiteboard.updateHitbox();
		whiteboard.scrollFactor.x = 0;
		whiteboard.scrollFactor.y = 0;
		whiteboard.antialiasing = true;
		add(whiteboard);

		var baldi:FlxSprite = new FlxSprite(0, -15).loadGraphic(Paths.image('da schoolhouse/menu/baldi', 'shared'));
		baldi.screenCenter();
		...
		var logo:FlxSprite = new FlxSprite(0, -15).loadGraphic(Paths.image('da schoolhouse/menu/logo', 'shared'));
		logo.screenCenter();
		...
		var tex = Paths.getSparrowAtlas('da schoolhouse/menu/FNF_main_menu_assets', 'shared');
